      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        <Reveal>
          ...
          <h1 className="mt-4 font-display text-4xl font-extrabold leading-tight text-white sm:text-5xl">
            Thinking from people who{" "}
            <span className="text-white">deliver banking programmes</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-text-muted">
            Points of view, whitepapers and articles on modernizing, migrating
            and running banking platforms — grounded in delivery, not theory.
          </p>
        </Reveal>
      </div>
    </section>
